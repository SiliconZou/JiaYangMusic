...
import UIKit
import CoreData
class HTHanguoViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/component/list.json?area=HOT_KR&offset=%ld&size=20", con)
