//
//  NOXianchangViewController.swift
//  MusicTai
//
...
import UIKit
import CoreData
class NOXianchangViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/navigation/list.json?area=US&type=US_LIVE&offset=%ld&size=20", con)
