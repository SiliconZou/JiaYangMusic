...
import UIKit
import CoreData
class HTOumeiViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/component/list.json?area=HOT_US&offset=%ld&size=20", con)
