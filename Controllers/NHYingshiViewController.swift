...
import UIKit
import CoreData
class NHYingshiViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/navigation/list.json?area=ML&type=ML_MV&offset=%ld&size=20", con)
//        let url = "http://mapiv2.yinyuetai.com/navigation/list.json?area=ML&type=ML_MV&offset=0&size=20"
