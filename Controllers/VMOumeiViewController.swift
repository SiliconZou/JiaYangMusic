...
import UIKit
import CoreData
class VMOumeiViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http:mapiv2.yinyuetai.com/vchart/trend.json?area=US&offset=%ld&size=20", con)
