...
import UIKit
import CoreData
class NRTuijianViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/navigation/list.json?area=JP&type=JP_REC&offset=%ld&size=20", con)
