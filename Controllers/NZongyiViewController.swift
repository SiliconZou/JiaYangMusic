...
import UIKit
import CoreData
class NZongyiViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/navigation/list.json?area=All_LIVE&type=All_LIVE&offset=%ld&size=20", con)
