...
import UIKit
import CoreData
class VMHanguoViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http:mapiv2.yinyuetai.com/vchart/trend.json?area=KR&offset=%ld&size=20", con)
