...
class VZJinkouViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func loadData(con:Int,size:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/album/trend_rank.json?offset=%ld&size=%ld&type=im", con,size)
