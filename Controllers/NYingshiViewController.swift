...
import UIKit
import CoreData
class NYingshiViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        ...
        let url = String.init(format: "http://mapiv2.yinyuetai.com/navigation/list.json?area=All_MV&type=All_MV&offset=%ld&size=20", con)
