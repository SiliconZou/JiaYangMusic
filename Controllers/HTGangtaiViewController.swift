...
import UIKit
import CoreData
class HTGangtaiViewController: UIViewController,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/component/list.json?area=HOT_HT&offset=%ld&size=20", con)
