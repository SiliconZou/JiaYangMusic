//
//  NHXianchangViewController.swift
//  MusicTai
//
...
import UIKit
import CoreData
class NHXianchangViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/navigation/list.json?area=ML&type=ML_LIVE&offset=%ld&size=20", con)
