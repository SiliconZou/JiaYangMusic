...
import UIKit
import CoreData
class NRYingshiViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func loadData(con:Int) {
        let url = String.init(format: "http://mapiv2.yinyuetai.com/navigation/list.json?area=JP&type=JP_MV&offset=%ld&size=20", con)
